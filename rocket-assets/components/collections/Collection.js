...
import { mapGetters as v } from "https://codigo-aberto-sandbox-assets.yampi.io.s3.amazonaws.com/yampi-templates-sandbox/rocket-assets/dist/vendor/vuex.js";
import y from "https://codigo-aberto-sandbox-assets.yampi.io.s3.amazonaws.com/yampi-templates-sandbox/rocket-assets/dist/vendor/modules/axios/api.js";
...
var P = function() {
  ...
  return n("Grid", { class: { completed: t.completed, "has-carousel": t.isCarousel }, attrs: { link: t.link, "show-link": t.showLink, loading: t.loading, title: t.collection.name, "products-per-line": t.productsPerLine, carousel: t.isCarousel, products: t.collectionProducts }, scopedSlots: t._u([{ key: "default", fn: function({ product: d }) {

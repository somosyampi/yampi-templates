function v(t, r, a, C, i, f, d, h) {
  var n = typeof t == "function" ? t.options : t;
  r && (n.render = r, n.staticRenderFns = a, n._compiled = !0), C && (n.functional = !0), f && (n._scopeId = "data-v-" + f);
  var o;
  if (d ? (o = function(e) {
    e = e || this.$vnode && this.$vnode.ssrContext || this.parent && this.parent.$vnode && this.parent.$vnode.ssrContext, !e && typeof __VUE_SSR_CONTEXT__ < "u" && (e = __VUE_SSR_CONTEXT__), i && i.call(this, e), e && e._registeredComponents && e._registeredComponents.add(d);
...
const H = g.exports;
function s(t) {
  s.installed || (s.installed = !0, t.component("Trashcan", H));
}
const L = {
  install: s
};

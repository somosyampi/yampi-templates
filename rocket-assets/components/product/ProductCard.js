...
import v from "@/editor/icons/IconBuyButton.js";
function C(r, t, e, u, s, i, c, d) {
  var o = typeof r == "function" ? r.options : r;
  t && (o.render = t, o.staticRenderFns = e, o._compiled = !0), u && (o.functional = !0), i && (o._scopeId = "data-v-" + i);
  var n;
  if (c ? (n = function(a) {
  ...
  }, o._ssrRegister = n) : s && (n = d ? function() {
    s.call(
      this,
...
const T = w.exports;
function _(r) {
  _.installed || (_.installed = !0, r.component("ProductCard", T));
}
const S = {
  install: _
};

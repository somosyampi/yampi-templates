...
var w = function() {
  ...
  return e("div", { staticClass: "product-customizations" }, [t.validProduct.simple ? t._e() : e("SelectSku", { ref: "selectSku", attrs: { "variations-style": t.variationsStyle, "show-error-message": !1 }, on: { update: t.handleSelectSkuUpdate } }), t.selectedSku && t.showBuyButton ? e("SkuCustomizations", { ref: "skuCustomizations", attrs: { sku: t.selectedSku }, on: { change: function(a) {
    return t.setCustomizations(a);
  } } }) : t._e(), t.showUnavailableMessage ? e("div", { staticClass: "main-product-unavailable alert -yellow" }, [t._v(" Produto indispon\xEDvel. ")]) : t._e(), t.showBuyButton ? [e("div", { staticClass: "main-product-buy-button-holder flex" }, [t.showQuantitySelector ? e("QuantitySelector", { attrs: { disabled: !t.canAddToCart }, model: { value: t.quantity, callback: function(a) {
    t.quantity = a;

...
import C from "https://codigo-aberto-sandbox-assets.yampi.io/yampi-templates-sandbox/rocket-assets/dist/vendor/mixins/tracking/sdk.js";
...
var z = function() {
  ...
  return i("div", { staticClass: "product-customizations" }, [t.validProduct.simple ? t._e() : i("SelectSku", { ref: "selectSku", attrs: { "variations-style": t.variationsStyle }, on: { update: function(o) {
    return t.setSelectedSku(o);
  } } }), t.selectedSku && t.showBuyButton ? i("SkuCustomizations", { ref: "skuCustomizations", attrs: { sku: t.selectedSku }, on: { change: function(o) {
    return t.setCustomizations(o);
  } } }) : t._e(), t.showBuyButton ? [i("div", { staticClass: "main-product-buy-button-holder flex" }, [t.showQuantitySelector ? i("QuantitySelector", { attrs: { disabled: !t.canAddToCart }, model: { value: t.quantity, callback: function(o) {
    t.quantity = o;
  }, expression: "quantity" } }) : t._e(), i("LoaderButton", { staticClass: "btn btn-primary", attrs: { title: t.buyButtonText, sending: t.loading, disabled: !t.canAddToCart, "listen-position": !0 }, on: { click: function(o) {
    return t.addToCart();
  } } })], 1)] : t._e(), t.showMobileFloatingButton ? i("FloatingButton", { attrs: { quantity: t.quantity, "loading-button": t.loading, disabled: !t.canAddToCart }, on: { click: function(o) {
    return t.addToCart("floating-button");
  }, "open-stock-notifications-modal": t.openStockNotificationsModal } }) : t._e(), t.showBuyButton ? t._e() : [i("div", { staticClass: "main-product-unavailable alert -yellow" }, [t._v(" Produto indispon\xEDvel. ")]), i("button", { staticClass: "btn-stock-notifications btn btn-secundary -block flex -hcenter -vcenter mt-23", on: { click: t.openStockNotificationsModal } }, [i("IconEmail", { staticClass: "fill-current mr-3" }), t._v(" Avise-me quando chegar ")], 1)], t.hasCashbackValid ? i("Cashback", { staticClass: "mt-21 mb-21", attrs: { "percent-amount": t.validCashback.percent_amount } }) : t._e(), t.firstValidSku && t.showInventoryCountdown ? i("InventoryCountdown") : t._e(), t.showShippingForm ? i("Zipcode", { attrs: { quantity: t.quantity, disabled: !t.firstValidSku } }) : t._e(), t.selectedSku || t.validProduct.simple ? i("ModalStockNotifications", { ref: "stockNotificationsModal", attrs: { sku: t.selectedSku || t.firstSku[0] }, on: { success: function(o) {

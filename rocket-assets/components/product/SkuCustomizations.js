...
const h = {
    ...
    watch: {
        sku: {
            immediate: !0,
            handler() {
                this.showContent = !r.get(this.sku, "allow_sell_without_customization", !0);
            }
        },
        values: {
            deep: !0,
    ...
    methods: {
        ...
        getMask(s) {
            ...
            return r.times(s.max_chars, r.constant(t[s.allowed_values]));
        },
        calculateSum() {
        ...
        checkValues(s = void 0) {
            ...
            return r.isEmpty(t) ? !0 : (t.forEach((e) => {
                this.setError(e.id, "Campo obrigatório");
            }), !1);
        },
        getInvalidCustomizations() {
            if (this.customizations.length === 0 || r.get(this.sku, "allow_sell_without_customization", !0))
                return;
            const s = this.customizations.filter((t) => r.isEmpty(this.values[t.id]));

import { mapGetters as r, mapActions as s } from "../vendor/vuex.js";
import d from "lodash/sumBy";
import l from "lodash/map";
import c from "../vendor/mixins/tracking/api.js";
import m from "../vendor/modules/eventBus.js";
function f(o, e, t, w, M, y, b, g) {
  ...
  methods: {
    ...
    async handleRedirectoToCart() {
      ...
      await this.handleTrackApi("checkout-intended", {
        ...
        items: l(this.cart.items, "name"),
        amount: d(this.cart.items, "price_total")
      }), this.redirectToCart();
    }
  }
};
...
const _ = C.exports;
function i(o) {
  i.installed || (i.installed = !0, o.component("ModalCartConfirmation", _));
}
const v = {
  install: i
};

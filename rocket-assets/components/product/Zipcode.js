...
import y from "https://codigo-aberto-sandbox-assets.yampi.io/yampi-templates-sandbox/rocket-assets/dist/vendor/mixins/errors.js";
import b from "https://codigo-aberto-sandbox-assets.yampi.io/yampi-templates-sandbox/rocket-assets/dist/vendor/mixins/product.js";
function z(t, e, a, s, r, d, p, h) {
  var i = typeof t == "function" ? t.options : t;
  e && (i.render = e, i.staticRenderFns = a, i._compiled = !0), s && (i.functional = !0), d && (i._scopeId = "data-v-" + d);
  var n;
  if (p ? (n = function(o) {
    o = o || this.$vnode && this.$vnode.ssrContext || this.parent && this.parent.$vnode && this.parent.$vnode.ssrContext, !o && typeof __VUE_SSR_CONTEXT__ < "u" && (o = __VUE_SSR_CONTEXT__), r && r.call(this, o), o && o._registeredComponents && o._registeredComponents.add(p);
...
const C = {
  ...
  methods: {
    ...
    formatCustomShippingPrice() {
      ...
      let e = 0, a = "", s = "", r = "";
      t.forEach((d) => {
        this.data[d].delivery_time > e && (e = this.data[d].delivery_time, a = this.data[d].city, s = this.data[d].zipcode, r = this.data[d].uf);
      }), this.data = {
        CUSTOMIZADO: {
...
var w = function() {
  ...
  return a("div", { staticClass: "main-product-shipping" }, [a("label", { attrs: { for: "zipcode" } }, [e._v("SIMULAR FRETE")]), a("form", { attrs: { id: "form-zipcode" }, on: { submit: function(s) {
    return s.preventDefault(), e.submit.apply(null, arguments);
  } } }, [a("div", { staticClass: "-holder relative" }, [a("input", { directives: [{ name: "model", rawName: "v-model", value: e.zipcode, expression: "zipcode" }, { name: "mask", rawName: "v-mask", value: "#####-###", expression: "'#####-###'" }], class: { error: e.hasError("zipcode") }, attrs: { "data-1p-ignore": "", type: "tel", name: "zipcode", placeholder: "Ex.: 00000-000", disabled: e.disabled }, domProps: { value: e.zipcode }, on: { input: function(s) {
    s.target.composing || (e.zipcode = s.target.value);
...
const k = $.exports;
function c(t) {
  c.installed || (c.installed = !0, t.component("Zipcode", k));
}
const M = {
  install: c
};

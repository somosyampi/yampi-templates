...
import w from "https://codigo-aberto-sandbox-assets.yampi.io.s3.amazonaws.com/yampi-templates-sandbox/rocket-assets/dist/vendor/modules/axios/api.js";
import m from "https://codigo-aberto-sandbox-assets.yampi.io.s3.amazonaws.com/yampi-templates-sandbox/rocket-assets/components/product/reviews/BaseContent.js";
...
var y = function() {
  ...
  }), 0), t("div", { staticClass: "btn btn-secundary -block mt-43", on: { click: e.showModal } }, [e._v(" Avaliar produto ")])]) : t("div", { staticClass: "btn btn-secundary", on: { click: e.showModal } }, [e._v(" Avaliar produto ")]), t("div", [e.payload.length ? [t("MasonryLayout", { scopedSlots: e._u([{ key: "header", fn: function() {

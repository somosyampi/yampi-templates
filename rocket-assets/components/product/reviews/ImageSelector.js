import _ from "https://codigo-aberto-sandbox-assets.yampi.io.s3.amazonaws.com/yampi-templates-sandbox/rocket-assets/dist/vendor/lodash.js";
...
var C = function () {
    ...
    return s("div", [s("div", { staticClass: "image-selector-label" }, [e._v(" Imagem do produto (opcional) ")]), s("div", { staticClass: "image-selector-container" }, e._l(parseInt(e.amount, 10), function (a) {
        return s("InputImage", {
            key: a, attrs: { item: a, "show-delete-button": !!(e.imagesUrls[a - 1] && e.imagesUrls[a - 1].length), disabled: e.checkIfDisabled(a), "is-multiple": !0, limit: parseInt(e.amount, 10), uplodaded: e.imagesUrls.length }, on: { change: (l) => e.handleChange(l), deleteImage: e.handleDelete }, scopedSlots: e._u([{
                key: "images", fn: function () {

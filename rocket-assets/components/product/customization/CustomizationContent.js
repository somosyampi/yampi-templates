import m from "https://codigo-aberto-sandbox-assets.yampi.io/yampi-templates-main/rocket-assets/dist/vendor/lodash.js";
import C from "https://codigo-aberto-sandbox-assets.yampi.io/yampi-templates-main/rocket-assets/components/product/customization/BaseCustomization.js";
...
var y = function () {
    ...
    return s("div", { staticClass: "customization-content" }, [t.sku.allow_sell_without_customization ? s("CustomRadioGroup", {
        attrs: {
            options: [
                {
                    key: 1,
            ...
            ], "initial-value": !1, value: t.showContent
        }, on: { pick: t.handlePickedOption }, scopedSlots: t._u([{
    ...
    }) : t._e(), t.showContent || !t.sku.allow_sell_without_customization ? s("div", { staticClass: "input-customization", attrs: { role: "form", "aria-labelledby": "customization-label" } }, [t._l(t.sku.customizations.data, function (a) {
        return s("div", { key: a.id }, [s("div", { staticClass: "input-customization-title", class: { "-optional": !a.required }, attrs: { id: "customization-label" } }, [t._v(" " + t._s(a.name) + " ")]), a.type === "input" ? s("input", {
            directives: [{ name: "mask", rawName: "v-mask", value: t.getMask(a), expression: "getMask(customization)" }], class: {
                error: t.hasError(a.id)
            }, attrs: { type: "text", placeholder: "Digite aqui..." }, domProps: { value: t.values[a.id] }, on: {
                input: function (i) {

import l from "https://codigo-aberto-sandbox-assets.yampi.io.s3.amazonaws.com/yampi-templates-sandbox/rocket-assets/dist/vendor/lodash.js";
import { smoothScroll as C } from "https://codigo-aberto-sandbox-assets.yampi.io.s3.amazonaws.com/yampi-templates-sandbox/rocket-assets/dist/vendor/mixins/helpers.js";
import w from "https://codigo-aberto-sandbox-assets.yampi.io.s3.amazonaws.com/yampi-templates-sandbox/rocket-assets/dist/vendor/mixins/errors.js";
import g from "https://codigo-aberto-sandbox-assets.yampi.io.s3.amazonaws.com/yampi-templates-sandbox/rocket-assets/components/product/customization/BaseCustomization.js";
...
var y = function () {
    ...
    return t.hasCustomizations ? e("div", { staticClass: "text-center" }, [t.sku.allow_sell_without_customization ? e("div", { staticClass: "-all-optional", on: { click: t.toggleShowContent } }, [e("span", { staticClass: "link-alike" }, [t._v("Personalize o Produto")]), e("SelectArrow", { staticClass: "icon icon-select-arrow", class: { "-up": t.showContent } })], 1) : t._e(), t.showContent ? e("div", { staticClass: "main-product-customization text-left" }, [e("div", { staticClass: "-title" }, [t._v(" Personalizar produto ")]), t._l(t.customizations, function (i) {
        return e("div", { key: i.id, staticClass: "customization" }, [e("label", { attrs: { for: `customization-${i.id}` } }, [t._v(" " + t._s(i.name) + " "), t.isMandatoryCustomization(i, t.sku.allow_sell_without_customization) ? e("span", { staticClass: "required" }) : t._e()]), i.type === "input" ? e("input", {
            directives: [{ name: "mask", rawName: "v-mask", value: t.getMask(i), expression: "getMask(customization)" }], ref: "customizationField", refInFor: !0, class: { error: t.hasError(i.id) }, attrs: { type: "text", placeholder: "Digite aqui...", maxlength: i.max_chars }, domProps: { value: t.values[i.id] }, on: {
                input: function (o) {
                    return t.setCustomizationValue(i, o.target.value, !0);
                }
            }
        }) : e("CustomSelect", {
            ref: "customizationField", refInFor: !0, class: { error: t.hasError(i.id) }, attrs: { value: "" }, on: {
                change: function (o) {

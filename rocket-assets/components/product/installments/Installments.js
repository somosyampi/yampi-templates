import v from "https://codigo-aberto-production-assets.yampi.io/yampi-templates-main/rocket-assets/dist/vendor/lodash.js";
import I from "https://codigo-aberto-production-assets.yampi.io/yampi-templates-main/rocket-assets/dist/vendor/vue-debounce.js";
import w from "https://codigo-aberto-production-assets.yampi.io/yampi-templates-main/rocket-assets/components/product/installments/BaseInstallments.js";
...
var C = function() {
  ...
  return a("div", [t.installments.installments ? [t.showAllInstallments ? [a("div", { staticClass: "show-installments link-alike", class: { "-loading": t.loading }, on: { click: function(d) {

...
import v from "https://codigo-aberto-sandbox-assets.yampi.io/yampi-templates-sandbox/rocket-assets/dist/vendor/mixins/merchant.js";
function w(e, a, i, n, o, l, c, u) {
  ...
  if (c ? (s = function(r) {
    ...
    if (t.functional) {
      t._injectStyles = s;
      var _ = t.render;
      t.render = function(m, g) {
        return s.call(g), _(m, g);
      };
    } else {
...
const $ = {
  ...
  methods: {
    ...
    async handleInstallments(e) {
      ...
      if (!a)
        return {};
      const i = this.isSku && f.get(this.validSku, "id") ? this.validSku : void 0;
      let n = f.get(
        i || this.validProduct,
        "prices.data.price"
      );
      this.productPrices && (n = this.productPrices.price);
      const o = f.get(this.validProduct, "id"), l = this.getLocalStorageCache(n, e);
      if (l)

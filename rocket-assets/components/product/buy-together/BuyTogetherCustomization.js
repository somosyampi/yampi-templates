import { mapGetters as z } from "https://codigo-aberto-sandbox-assets.yampi.io/yampi-templates-sandbox/rocket-assets/dist/vendor/vuex.js";
...
var g = function () {
    ...
    }), o("p", { staticClass: "helper-text" }, [t._v(" Editar ")])])]), o("ModalBuyTogetherCustomization", {
        ref: "ModalBuyTogetherCustomization", attrs: { "products-for-customization": t.productsForCustomization, "customized-products": t.customizedProducts, "combo-id": t.comboId }, on: {
            save: t.handleSave, addSkuCustomization: function (n) {

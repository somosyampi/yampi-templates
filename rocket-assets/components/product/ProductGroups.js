import m from "https://codigo-aberto-sandbox-assets.yampi.io.s3.amazonaws.com/yampi-templates-sandbox/rocket-assets/components/product/BaseProduct.js";
...
var b = function() {
  ...
  return n.payload.length || n.loading ? t("div", { directives: [{ name: "observe-visibility", rawName: "v-observe-visibility", value: {
    callback: n.visibilityChanged,
    once: !0
  }, expression: `{
        callback: visibilityChanged,
        once: true,
    }` }], staticClass: "main-product-group" }, [t("div", { staticClass: "-title", class: { "-loading": n.loading } }, [n._v(" Outras op\xE7\xF5es ")]), t("ul", { staticClass: "inline" }, n._l(n.payload, function(s) {

...
import y from "https://images-dev.yampi.me/rocket-sandbox/b/01-dev/latest/dist/vendor/modules/axios/rocket.js";
...
var w = function() {
  ...
  return e.ready ? r("div", { staticClass: "section-grid-collection--container container" }, [r("div", { staticClass: "section-grid-collection--text" }, [r("h2", { staticClass: "title-text", domProps: { innerHTML: e._s(e.titleText) } }), r("p", { staticClass: "subtitle-text", domProps: { innerHTML: e._s(e.subtitleText) } })]), r("div", { staticClass: "section-grid-collection--content", class: e.contentClasses }, [r("div", { staticClass: "section-grid-collection--banner" }, [e.loading ? e._e() : r("RocketAnchor", e._b({ attrs: { label: "" } }, "RocketAnchor", e.linkConfig, !1), [e.hasBannerStopwatch ? r("BannerStopwatch") : e._e(), r("CustomImage", { attrs: { src: e.getImage(e.banner) || "", alt: `${e.banner ? e.banner.name : ""}`, lazyload: !0 } })], 1)], 1), r("div", { staticClass: "section-grid-collection--products" }, e._l(e.resourceProducts, function(u, o) {

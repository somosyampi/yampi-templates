...
var S = function() {
  ...
  return e.ready ? n("div", { staticClass: "section-text-button-2-banners--container container", class: e.customContainerClasses }, [n("div", { staticClass: "section-text-button-2-banners--description", class: e.customDescriptionClasses }, [n("div", { staticClass: "title-text", domProps: { innerHTML: e._s(e.titleText) } }), n("div", { staticClass: "description-text", domProps: { innerHTML: e._s(e.descriptionText) } }), n("div", [e.buttonSwitch ? n("RocketAnchor", e._b({ attrs: { "custom-classes": `section--button --${e.buttonStyle} ellipsis-multiline`, label: e.textInButton, href: e.linkInButton } }, "RocketAnchor", e.computedAttrs, !1)) : e._e()], 1)]), n("div", { staticClass: "section-text-button-2-banners--banners", class: e.customBannersClasses }, e._l(e.computedBanners, function(i) {
    return n("CustomImage", { key: i.id, attrs: { src: e.getImage(i) || e.srcFirstPlaceholder, alt: `${e.banners.name}`, lazyload: !0 } });
  }), 1)]) : e._e();
}, P = [], k = /* @__PURE__ */ C(
  w,
  S,

...
var b = function() {
  ...
  return t("Transition", { attrs: { name: "fadeHeight" } }, [r.showSearchBar ? t("div", [t("form", { staticClass: "search-bar", attrs: { id: "product-search", role: "search", action: "/busca" }, on: { submit: function(s) {
    return s.preventDefault(), r.search.apply(null, arguments);
  } } }, [t("label", { staticClass: "-hide", attrs: { for: "product-name" } }, [r._v("Busca")]), t("input", { directives: [{ name: "model", rawName: "v-model", value: r.productName, expression: "productName" }], attrs: { id: "product-name", type: "text", name: "product-name", placeholder: "Buscar produto" }, domProps: { value: r.productName }, on: { input: function(s) {

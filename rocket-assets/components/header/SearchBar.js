(function () { "use strict"; try { if (typeof document < "u") { var r = document.createElement("style"); r.appendChild(document.createTextNode(".search-container[data-v-141e1dd0]{position:relative;width:100%}.search-bar input[data-v-141e1dd0]{border:1px solid var(--black-lightest);transition:border-color .2s}.search-bar input.input-focused[data-v-141e1dd0]{border-radius:var(--theme-border-radius);border:2px solid var(--black-dark-color-contrast);outline:none}.search-bar input.suggestions-border-active[data-v-141e1dd0]{border-radius:var(--theme-border-radius) var(--theme-border-radius) 0 0;border:2px solid var(--black-dark-color-contrast);border-bottom:1px solid #E5E5E5}.search-bar input[data-v-141e1dd0]:hover{border-color:#b5b5b5}.suggestions-box[data-v-141e1dd0]{position:absolute;top:100%;left:0;right:0;background:var(--white);border-radius:0 0 var(--theme-border-radius) var(--theme-border-radius);margin-top:-1px;max-height:none;border:2px solid var(--black-dark-color-contrast);padding:3px;border-top:1.5px solid #E5E5E5}.suggestions-box ul[data-v-141e1dd0]{list-style:none;padding:0;margin:0}.suggestions-box li[data-v-141e1dd0]{padding:10px 16px;cursor:pointer;display:flex;align-items:center;font-size:14px;background:white;color:rgb(var(--black-dark-rgb));transition:background .15s,color .15s;border-radius:var(--theme-border-radius)}.suggestions-box li.active[data-v-141e1dd0],.suggestions-box li[data-v-141e1dd0]:hover{background-color:var(--white-smoke);color:#666}.suggestions-box li b[data-v-141e1dd0]{font-weight:var(--font-black);color:inherit}")), document.head.appendChild(r) } } catch (e) { console.error("vite-plugin-css-injected-by-js", e) } })();
import { mapGetters as p } from "https://openstore-production-assets.yampi.io/yampi-templates-main/rocket-assets/dist/vendor/vuex.js";
import { debounce as S } from "https://openstore-production-assets.yampi.io/yampi-templates-main/rocket-assets/dist/vendor/mixins/helpers.js";
...
import y from "https://openstore-production-assets.yampi.io/yampi-templates-main/rocket-assets/dist/vendor/mixins/cache.js";
function b(s, e, n, t, o, u, l, m) {
...
var C = function () {
    ...
    return n("Transition", { attrs: { name: "fadeHeight" } }, [e.showSearchBar ? n("div", { staticClass: "search-container" }, [n("form", {
    ...
    }, [n("label", { staticClass: "-hide", attrs: { for: "product-name" } }, [e._v("Busca")]), n("input", {
        directives: [{ name: "model", rawName: "v-model", value: e.productName, expression: "productName" }], class: {
            "input-focused": e.isInputFocused,
            "suggestions-border-active": e.showSuggestions && e.suggestions.length > 0
        }, attrs: { id: "product-name", type: "text", name: "product-name", placeholder: "Buscar produto", autocomplete: "off" }, domProps: { value: e.productName }, on: {
            input: [function (t) {
        ...
        return n("li", {
            key: o, class: { active: e.currentIndex === o }, on: {

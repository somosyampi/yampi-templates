import p from "https://codigo-aberto-sandbox-assets.yampi.io.s3.amazonaws.com/yampi-templates-sandbox/rocket-assets/components/header/cart/BaseCart.js";
...
var w = function () {
    ...
    return e("NavigationDrawer", { ref: "navigationDrawer", on: { beforeEnter: t.handleBeforeEnter, afterEnter: t.handleAfterEnter, afterLeave: t.handleAfterLeave } }, [e("div", { staticClass: "side-cart-container" }, [e("div", {
    ...
    }, [t._v(" " + t._s(t.emptyCartTextButton) + " ")])]) : e("div", { staticClass: "continue-buying", on: { click: t.handleShow } }, [e("span", [e("SelectArrow", { staticClass: "icon icon-select-arrow -left" })], 1), t._v(" Continuar comprando ")])]) : e("div", {
        staticClass: "side-cart-content", class: {
            "--overflows": t.isOverflowing
        }
    }, [e("div", {
        ref: "sideCartProductList", staticClass: "side-cart-products-list", class: {
            "--overflows": t.isOverflowing
        }
    ...
    })], 2), e("Transition", { attrs: { name: "fade" } }, [t.showButton ? e("div", {
        staticClass: "side-cart-button-container", class: {
            "--overflows": t.isOverflowing
        }
        ...
        staticClass: "btn btn-primary side-cart-button", attrs: { title: t.buttonText, sending: t.anyLoading, disabled: t.anyLoading }, on: {
            click: function (s) {
                return t.redirect();
            }
        }

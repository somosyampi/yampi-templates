(function(){"use strict";try{if(typeof document<"u"){var e=document.createElement("style");e.appendChild(document.createTextNode(".touchable[data-v-82ef9de8]{height:100%;width:100%}")),document.head.appendChild(e)}}catch(t){console.error("vite-plugin-css-injected-by-js",t)}})();
...
function g(i, e, n, a, r, f, u, h) {
  var t = typeof i == "function" ? i.options : i;
  e && (t.render = e, t.staticRenderFns = n, t._compiled = !0), a && (t.functional = !0), f && (t._scopeId = "data-v-" + f);
  var o;
  if (u ? (o = function(s) {
  ...
  }, t._ssrRegister = o) : r && (o = h ? function() {
    r.call(
      this,
...
var S = function() {
  ...
  return n("div", { staticClass: "touchable" }, [n("Splide", { ref: "splideRef", staticClass: "custom-splide", attrs: { options: {
    ...
    drag: !1,
    start: 0
  }, slides: e.images }, on: { "splide:moved": e.handleSplideMoved, "splide:mounted": e.handleSplideMounted } }, e._l(e.images, function(a) {

...
var b = function() {
  ...
  return e.loading || e.products.length > 0 ? n("section", [n("div", { staticClass: "container holder-collection" }, [n("div", { staticClass: "flex -between" }, [n("div", { staticClass: "holder-left flex -vcenter" }, [n("h2", { staticClass: "theme-title collection-name", class: { "-loading": e.loading }, domProps: { textContent: e._s(e.title || "loading collection title") } }), e.isMobile && e.showLink || !e.isMobile && e.link ? n("a", { staticClass: "collection-link", class: { "-loading": e.loading }, attrs: { href: e.link } }, [e._v(" Ver todos ")]) : e._e()])]), n("RocketEmitter", { attrs: { emits: "grids", label: "Vitrine de produtos" } }, [e.products.length ? n("ProductsList", { class: { "-carousel": e.carousel }, attrs: { products: e.products, carousel: e.carousel, loading: e.loading, "products-per-line": e.productsPerLine, "is-mobile": e.isMobile }, scopedSlots: e._u([{ key: "default", fn: function({ product: r }) {

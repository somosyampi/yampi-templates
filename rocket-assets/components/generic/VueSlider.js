...
function v(a, e, n, s, o, d, c, m) {
  ...
  if (c ? (l = function(i) {
  ...
  }, t._ssrRegister = l) : o && (l = m ? function() {
    o.call(
      this,
    ...
    if (t.functional) {
      ...
      t.render = function(f, p) {
        return l.call(p), _(f, p);
      };
    } else {
      var h = t.beforeCreate;
      t.beforeCreate = h ? [].concat(h, l) : [l];
    }
  return {
    exports: a,
    options: t
...
var g = function() {
  ...
  return n("div", { staticClass: "vue-slider", style: `height: ${e.height}px;` }, [n("div", { staticClass: "vue-slider__wrapper" }, [n("div", { staticClass: "vue-slider__background" }), n("div", { staticClass: "vue-slider__track", style: e.trackStyle }), n("input", { directives: [{ name: "model", rawName: "v-model", value: e.localMin, expression: "localMin" }], attrs: { type: "range", min: e.min, max: e.max, step: e.step }, domProps: { value: e.localMin }, on: { input: e.updateMin, change: e.onSliderChange, __r: function(s) {
    e.localMin = s.target.value;
  } } }), n("input", { directives: [{ name: "model", rawName: "v-model", value: e.localMax, expression: "localMax" }], attrs: { type: "range", min: e.min, max: e.max, step: e.step }, domProps: { value: e.localMax }, on: { input: e.updateMax, change: e.onSliderChange, __r: function(s) {

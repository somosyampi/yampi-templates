...
var b = function() {
  ...
  return i("RocketEmitter", { staticClass: "side-cart-emitter", attrs: { emits: "cart", label: "Carrinho de compras" }, on: { openCategory: e.handleDrawer } }, [i("Transition", { attrs: { name: "drawer-animation" }, on: { "after-enter": e.afterEnter, "before-enter": e.beforeEnter, "after-leave": e.afterLeave, "before-leave": e.beforeLeave } }, [e.active ? i("div", { staticClass: "navigation-drawer-background", on: { click: function(a) {
    return a.stopPropagation(), e.handleDrawer.apply(null, arguments);
  } } }, [i("div", { staticClass: "navigation-drawer-container", on: { click: function(a) {
    a.stopPropagation();

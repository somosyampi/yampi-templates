import { uuidv4 as m } from "https://codigo-aberto-sandbox-assets.yampi.io.s3.amazonaws.com/yampi-templates-sandbox/rocket-assets/dist/vendor/mixins/helpers.js";
...
var $ = function () {
    ...
    return o("div", { staticClass: "stepper-container" }, [o("ul", { staticClass: "progressbar" }, t._l(t.items, function (a, r) {
        return o("li", {
            key: t.calculateKey(a), class: t.stepClass(a), on: {
                click: function (u) {

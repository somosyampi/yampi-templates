function g(i, o, a, _, r, f, u, p) {
  var e = typeof i == "function" ? i.options : i;
  o && (e.render = o, e.staticRenderFns = a, e._compiled = !0), _ && (e.functional = !0), f && (e._scopeId = "data-v-" + f);
  var t;
  if (u ? (t = function(n) {
    ...
    if (e.functional) {
      e._injectStyles = t;
      var m = e.render;
      e.render = function(c, h) {
        return t.call(h), m(c, h);
      };
    } else {
...
var y = function() {
  ...
  return a("div", { staticClass: "loader-bg", style: o.getStyle() });
}, C = [], b = /* @__PURE__ */ g(
  v,
  y,
  C,
...
const w = b.exports;
function s(i) {
  s.installed || (s.installed = !0, i.component("Loader", w));
}
const $ = {
  install: s
};

import { mapMutations as _ } from "https://codigo-aberto-sandbox-assets.yampi.io.s3.amazonaws.com/yampi-templates-sandbox/rocket-assets/dist/vendor/vuex.js";
import { uuidv4 as A, getImageMeta as v } from "https://codigo-aberto-sandbox-assets.yampi.io.s3.amazonaws.com/yampi-templates-sandbox/rocket-assets/dist/vendor/mixins/helpers.js";
...
var w = function () {
    ...
    return n("img", e._b({
        directives: [{ name: "lazyload", rawName: "v-lazyload", value: e.lazyload, expression: "lazyload" }], attrs: { src: e.lazyload ? e.placeholderImg : e.imgSrc, "data-src": e.lazyload ? e.imgSrc : null, width: e.width, height: e.height, onerror: e.handleError() }, on: {
            load: e.handleLoad, click: function (d) {
                return e.$emit("click");
            }
        }
    }, "img", e.$attrs, !1));

...
var V = function() {
  ...
  return s("div", { class: e.selectType }, [e.iconUrl ? s("img", { staticClass: "icon svg-brand", class: { "-error": e.error || e.internalError }, attrs: { src: e.iconUrl } }) : e._e(), s("select", e._b({ directives: [{ name: "model", rawName: "v-model", value: e.selectedValue, expression: "selectedValue" }], ref: "standardSelect", class: { error: e.error || e.internalError }, on: { change: [function(o) {
  ...
  }, e.change] } }, "select", e.$attrs, !1), [e._t("default")], 2), s("SelectArrow", { staticClass: "icon icon-select-arrow", class: { "-error": e.error || e.internalError } })], 1);
}, w = [], y = /* @__PURE__ */ g(
  C,
  V,
  w,

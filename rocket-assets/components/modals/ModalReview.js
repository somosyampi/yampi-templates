...
var C = function() {
  ...
  }, proxy: !0 }]) }, [r("form", { ref: "ReviewFormRef" }, [r("label", { attrs: { for: "review-rating" } }, [e._v("QUANTIDADE DE ESTRELAS")]), r("br"), e._l(e.times(5), function(t) {
    return r("i", { key: t, staticClass: "icon", class: `icon-star-${t < e.form.rating ? "dynamic" : "grey"}`, on: { click: function(n) {
      e.form.rating = t + 1;
    } } });
  }), r("br"), r("label", { staticClass: "custom-margin", attrs: { for: "review-name" } }, [e._v("NOME")]), r("input", { directives: [{ name: "model", rawName: "v-model", value: e.form.name, expression: "form.name" }], class: { error: e.hasError("name") }, attrs: { id: "review-name", type: "text", name: "name", placeholder: "Ex.: Adriana", maxlength: "60" }, domProps: { value: e.form.name }, on: { input: function(t) {
    t.target.composing || e.$set(e.form, "name", t.target.value);
  } } }), r("ErrorText", { attrs: { text: e.getError("name") } }), r("label", { attrs: { for: "review-email" } }, [e._v("E-MAIL")]), r("input", { directives: [{ name: "model", rawName: "v-model", value: e.form.email, expression: "form.email" }], class: { error: e.hasError("email") }, attrs: { id: "review-email", type: "email", name: "email", placeholder: "Ex.: adriana@gmail.com" }, domProps: { value: e.form.email }, on: { input: function(t) {
    t.target.composing || e.$set(e.form, "email", t.target.value);
  } } }), r("ErrorText", { attrs: { text: e.getError("email") } }), r("label", { attrs: { for: "review-message" } }, [e._v("AVALIA\xC7\xC3O")]), r("textarea", { directives: [{ name: "model", rawName: "v-model", value: e.form.message, expression: "form.message" }], class: { error: e.hasError("message") }, attrs: { id: "review-message", type: "text", name: "review", placeholder: "Escreva o que voc\xEA achou deste produto...", rows: "4", maxlength: "250" }, domProps: { value: e.form.message }, on: { input: function(t) {

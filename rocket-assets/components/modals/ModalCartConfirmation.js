...
const g = {
    ...
    mounted() {
        M.$on("addedToCart", this.showModal);
    },
    methods: {
        ...v("cart", ["redirectToCart"]),
        showModal() {
            this.$refs.cartConfirmBaseModal && this.$refs.cartConfirmBaseModal.showModal();
        },
        closeModal() {
...
const y = b.exports;
function d(n) {
    d.installed || (d.installed = !0, n.component("ModalCartConfirmation", y));
}
const T = {
    install: d
};

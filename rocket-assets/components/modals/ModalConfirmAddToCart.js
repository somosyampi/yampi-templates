import o from "https://codigo-aberto-sandbox-assets.yampi.io/yampi-templates-sandbox/rocket-assets/dist/vendor/lodash.js";
import { mapGetters as f, mapActions as C } from "https://codigo-aberto-sandbox-assets.yampi.io/yampi-templates-sandbox/rocket-assets/dist/vendor/vuex.js";
...
import { createPriceObjects as y } from "https://codigo-aberto-sandbox-assets.yampi.io/yampi-templates-sandbox/rocket-assets/dist/vendor/mixins/helpers.js";
...
var w = function () {
    ...
    return e("Modal", { ref: "baseModal", attrs: { name: "confirm-add-to-cart", title: t.modalTitle }, on: { close: t.resetComponent } }, [t.product && t.product.skus ? [e("div", { staticClass: "pl-sm-40 pl-xs-24 mb-38" }, [e("div", { staticClass: "product" }, [e("CustomImage", { key: t.imageUrl, staticClass: "-loading", attrs: { src: t.imageUrl, alt: t.product.name, thumbor: { resize: "60x60" }, width: "60", height: "60" } }), e("div", { staticClass: "text" }, [e("p", { staticClass: "name ellipsis-multiline", class: t.ellipsisClass }, [t._v(" " + t._s(t.product.name) + " ")]), t.selectedSku && t.selectedSku.variations.length ? e("ul", t._l(t.selectedSku.variations, function (a) {
        ...
        directives: [{ name: "show", rawName: "v-show", value: t.product.has_variations && !t.showCustomization, expression: "product.has_variations && !showCustomization" }], ref: "selectSku", attrs: { product: t.product }, on: {
            update: function (a) {

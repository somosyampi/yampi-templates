(function(){"use strict";try{if(typeof document<"u"){var e=document.createElement("style");e.appendChild(document.createTextNode(".helper-text[data-v-b9c7dcd2]{font-size:14px;line-height:1.6;margin-bottom:15px}.product[data-v-b9c7dcd2]{background-color:var(--default-background-color);border-radius:var(--theme-border-radius);display:flex;align-items:center;margin:0 auto 31px;padding:17px 19px;width:100%}.product img[data-v-b9c7dcd2]{height:60px;margin:0 15px 0 0;width:60px;border-radius:var(--mini-cart-product-border-radius)}.product .name[data-v-b9c7dcd2]{color:var(--color-general-primary);font-size:14px;line-height:1.15;font-weight:var(--font-medium);word-break:break-word}")),document.head.appendChild(e)}}catch(d){console.error("vite-plugin-css-injected-by-js",d)}})();
...
import k from "https://codigo-aberto-sandbox-assets.yampi.io/yampi-templates-sandbox/rocket-assets/dist/vendor/mixins/tracking/sdk.js";
...
const C = {
  ...
  methods: {
    ...
    async submit() {
      ...
      try {
        await g.post(`/products/${this.sku.product_id}/stock-notifications`, i), this.handleTrackSDK("notify_when_available_subscribed"), this.closeModal(), this.$emit("success");
      } catch (t) {
...
var y = function() {
  ...
  return e("div", [e("Modal", { ref: "stockNotificationsModal", attrs: { name: "stock-notifications", title: "Avise-me quando chegar" }, on: { close: t.resetForm } }, [e("p", { staticClass: "helper-text" }, [t._v(" N\xF3s te avisaremos por e-mail quando este produto estiver novamente em nosso estoque. ")]), e("div", { staticClass: "mb-30" }, [e("div", { staticClass: "product" }, [e("CustomImage", { staticClass: "-loading", attrs: { src: t.sku.images.data[0].url, alt: t.sku.name, thumbor: { resize: "60x60" } } }), e("div", { staticClass: "text" }, [e("p", { staticClass: "name" }, [t._v(" " + t._s(t.sku.title) + " ")])])], 1)]), e("form", { attrs: { id: "form-stock-notifications" }, on: { submit: function(s) {
    return s.preventDefault(), t.submit.apply(null, arguments);
  } } }, [e("label", { attrs: { for: "stock-notifications-name" } }, [t._v("NOME")]), e("div", { staticClass: "holder-input mb-24" }, [e("input", { directives: [{ name: "model", rawName: "v-model", value: t.form.name, expression: "form.name" }], class: { error: t.hasError("name") }, attrs: { id: "stock-notifications-name", type: "text", name: "stock-notifications-name", placeholder: "Adriana" }, domProps: { value: t.form.name }, on: { input: [function(s) {
    s.target.composing || t.$set(t.form, "name", s.target.value);
  }, function(s) {
    return t.setError("name", "");
  }] } }), e("ErrorText", { attrs: { text: t.getError("name") } })], 1), e("label", { attrs: { for: "stock-notifications-email" } }, [t._v("E-MAIL")]), e("div", { staticClass: "holder-input" }, [e("input", { directives: [{ name: "model", rawName: "v-model", value: t.form.email, expression: "form.email" }], class: { error: t.hasError("email") }, attrs: { id: "stock-notifications-email", type: "email", name: "stock-notifications-email", placeholder: "Ex.: adriana@gmail.com" }, domProps: { value: t.form.email }, on: { input: [function(s) {

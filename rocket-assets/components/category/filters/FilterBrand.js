import m from "https://codigo-aberto-sandbox-assets.yampi.io.s3.amazonaws.com/yampi-templates-sandbox/rocket-assets/components/category/filters/BaseFilter.js";
...
var b = function() {
  ...
  return o("div", { staticClass: "filter filter-brand" }, [o("div", { staticClass: "-title" }, [t._v(" Marca ")]), o("ul", t._l(t.payload, function(l) {
    return o("li", { key: l.id, staticClass: "filter-option" }, [o("CustomCheckbox", { attrs: { text: l.name, checked: l.active }, on: { change: function(a) {

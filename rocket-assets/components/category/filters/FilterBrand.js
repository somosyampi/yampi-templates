import v from "https://openstore-production-assets.yampi.io/yampi-templates-main/rocket-assets/components/category/filters/BaseFilter.js";
...
var g = function () {
    ...
    return a("div", { staticClass: "filter filter-brand" }, [a("div", { staticClass: "-title" }, [t._v(" Marca ")]), a("ul", t._l(t.currentPayload, function (i) {
        return a("li", { key: i.id, staticClass: "filter-option" }, [a("CustomCheckbox", {
            attrs: { text: i.name, checked: i.active }, on: {
                change: function (s) {

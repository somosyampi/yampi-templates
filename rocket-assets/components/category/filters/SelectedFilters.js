import { mapGetters as C, mapActions as m } from "https://codigo-aberto-sandbox-assets.yampi.io.s3.amazonaws.com/yampi-templates-sandbox/rocket-assets/dist/vendor/vuex.js";
import F from "https://codigo-aberto-sandbox-assets.yampi.io.s3.amazonaws.com/yampi-templates-sandbox/rocket-assets/dist/vendor/mixins/queryParams.js";
...
var $ = function() {
  ...
  return n.activeFilters.length ? a("div", { staticClass: "selected-filters" }, n._l(n.activeFilters, function(s) {
    return a("div", { key: s.alias, staticClass: "selected-filter", domProps: { textContent: n._s(s.name) }, on: { click: function(o) {

import h from "https://codigo-aberto-sandbox-assets.yampi.io.s3.amazonaws.com/yampi-templates-sandbox/rocket-assets/components/category/filters/BaseFilter.js";
...
var y = function () {
    ...
    return n.payload.length ? r("div", { staticClass: "filter filter-category" }, [r("div", { staticClass: "-title" }, [n._v(" Promo\xE7\xF5es ")]), r("ul", n._l(n.payload, function (l) {
        return r("li", { key: l.id, staticClass: "filter-option" }, [r("CustomCheckbox", {

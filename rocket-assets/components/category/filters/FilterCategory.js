...
var g = function() {
  ...
  return e.currentPayload.length ? o("div", { staticClass: "filter filter-category" }, [o("div", { staticClass: "-title" }, [e._v(" Categorias ")]), o("ul", { class: { "-category": !e.showCheckbox } }, e._l(e.currentPayload, function(n) {
    return o("li", { key: n.id, class: { "filter-option": e.showCheckbox } }, [e.showCheckbox ? o("CustomCheckbox", { attrs: { text: n.name, checked: n.active }, on: { change: function(s) {
      return e.updateFilterStatus(n, s);
    } }, scopedSlots: e._u([{ key: "count", fn: function() {
      return [n.count ? o("span", [e._v(e._s(`(${n.count})`))]) : e._e()];
    }, proxy: !0 }], null, !0) }) : o("a", { class: { active: n.name === e.activeCategory }, attrs: { href: n.url_path }, domProps: { textContent: e._s(n.name) } })], 1);
  }), 0)]) : e._e();
}, w = [], S = /* @__PURE__ */ v(
  y,
  g,

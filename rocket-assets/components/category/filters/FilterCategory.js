import v from "https://codigo-aberto-sandbox-assets.yampi.io.s3.amazonaws.com/yampi-templates-sandbox/rocket-assets/components/category/filters/BaseFilter.js";
...
var b = function () {
    ...
    return e.payload.length ? a("div", { staticClass: "filter filter-category" }, [a("div", { staticClass: "-title" }, [e._v(" Categorias ")]), a("ul", { class: { "-category": !e.showCheckbox } }, e._l(e.payload, function (n) {
        return a("li", { key: n.id, class: { "filter-option": e.showCheckbox } }, [e.showCheckbox ? a("CustomCheckbox", {

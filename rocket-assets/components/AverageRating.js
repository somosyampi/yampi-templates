import u from "lodash/times";
import { mapGetters as c } from "../vendor/vuex.js";
import { uuidv4 as m, smoothScroll as d } from "../vendor/mixins/helpers.js";
...
var h = function() {
  ...
  return i("div", { staticClass: "average-rating-container", class: { "is-grid": t.isGrid }, on: { click: t.handleScroll } }, [t._l(t._times(5), function(n) {

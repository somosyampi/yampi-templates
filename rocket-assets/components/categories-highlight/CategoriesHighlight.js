...
var P = function() {
  ...
  return !e.loading && e.categories.length ? s("div", { key: e.screenWidth, staticClass: "container c-highlight-container" }, [e.sectionTitle ? s("div", { staticClass: "c-highlight-header" }, [s("div", { staticClass: "theme-title c-highlight-header__title", class: {
    "--full-width": !e.useVueSplide,
    "--mobile": e.isMobile
  } }, [e._v(" " + e._s(e.sectionTitle) + " ")])]) : e._e(), s("div", { staticClass: "c-highlight-content" }, [e.categories ? s(e.tagOrDiv("splide"), { ref: "CarousselRef", tag: "component", class: {

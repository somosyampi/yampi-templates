...
var p = function () {
    ...
    }), 0), t("div", { staticClass: "btn btn-secundary -block mt-43", on: { click: e.showModal } }, [e._v(" Avaliar produto ")])]) : t("div", { staticClass: "btn btn-secundary", on: { click: e.showModal } }, [e._v(" Avaliar produto ")]), t("div", [e.payload.length ? [t("masonry-layout", {
        scopedSlots: e._u([{

<template>
    ...
    >
        <path
            d="M10.0898 5.98438H11.9758C13.496 5.98438 14.7759 7.1215
            ...
            11.9758 7.98438L10.0898 7.98438V5.98438Z"
            :fill="color"
        />
        <path
            d="M17.1406 27C17.831 27 18.3906 26.4404 18.3906 25.75
            C18.3906 25.0596 17.831 24.5 17.1406 24.5C16.4503
            24.5 15.8906 25.0596 15.8906 25.75C15.8906 26.4404
            16.4503 27 17.1406 27Z"
            :fill="color"
        />
        <path
            d="M22.626 27C23.3163 27 23.876 26.4404 23.876 25.75
        ...
        />
        <path
            d="M6.5 18.417H3.5V16.417H6.5V13.417H8.5V16.417H11.5
            V18.417H8.5V21.417H6.5V18.417Z"
            :fill="color"
        />
    </svg>
</template>

...
export default {
    ...
    methods: {
        getCalculatedSubmenuLeftOffset({ drawPosition, clientX, itemWidth, viewportWidth }) {
            ...
            return {
                rightDraw: () => {
                    ...
                    const distIfOverflows = clientX > (itemOverflowsWidth + distToLastColumn) ?  clientX - (itemOverflowsWidth + distToLastColumn) : clientX - (itemOverflowsWidth);

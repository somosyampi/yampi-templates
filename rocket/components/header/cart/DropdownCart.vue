    ...
    >
        ...
        >
            ...
            >
                ...
                >
                    <div class="side-cart-row">
                        <span class="side-cart-total-text"><b>
                            {{ getCartValueByPaymentMethod.percentage }}% DE DESCONTOS</b> NO BOLETO
                        </span>
                        <span>
                ...
                >
                    <div class="side-cart-row">
                        <span class="side-cart-total-text">
                            <b>{{ getCartValueByPaymentMethod.percentage }}% DE DESCONTOS</b> NO PIX
                        </span>
                        <span>
                            <b>{{ getCartValueByPaymentMethod.value | formatMoney }}</b>
                        </span>
